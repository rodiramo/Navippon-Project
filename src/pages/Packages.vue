...
export default {
  ...
  methods: {
    async checkAdminStatus() {
      ...
      if (this.isAdmin) {
      this.$router.push(`/delete-package/${pkg.id}`);
      }
      },
  },
...
<template>
        ...
        <section class="hero hero-home">
            ...
            <p class="mb-4">Check our destination packages, with activities that suit only you!</p>
           
            <router-link class="btn" v-if="isAdmin" :to="`/create-package`">Create new Package</router-link>
